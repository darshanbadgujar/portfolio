...
export default function App({ Component, pageProps }: AppProps) {
  return (
    <>
      <Head>
        <title>Darshan Badgujar | SDE</title>
        <meta
          name="description"
          content="Portoflio site of Software Developer Darshan Badgujar."
        />
        <meta
          name="keywords"
          content="darshanbadgujar, darshan badgujar, darshan, badgujar, sde, kkw, university, nashik"
        />
        <meta
